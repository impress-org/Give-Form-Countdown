...
function gdd_version_notice() {
	echo '<div class="error"><p>' . sprintf( __( '<strong>Activation Error:</strong> You must have <a href="%s" target="_blank">Give</a> minimum version %s for the Donation Duration Add-on to activate.', 'give-donation-duration' ), 'https://givewp.com', GDD_MIN_GIVE_VER ) . '</p></div>';
}
